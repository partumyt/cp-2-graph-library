На основі завантажених файлів я підготував структуру для `README.md`, яка описує вашу бібліотеку для роботи з графами, консольний інтерфейс і візуалізацію. 
